...
export * from './routes/termdb.aggregateMatrix.ts'
export * from './routes/termdb.animatedBubbleChart.ts'
export * from './routes/termdb.barsql.ts'
export * from './routes/termdb.brainRegions.ts'
export * from './routes/termdb.bubbleHeatmap.ts'
export * from './routes/termdb.cellTypeBubbleHeatmap.ts'
...
export * from './routes/termdb.cuminc.ts'
...
export * from './routes/termdb.dmrBatch.ts'
export * from './routes/termdb.facet.ts'
export * from './routes/termdb.geneRanking.ts'
export * from './routes/termdb.isoformAvailability.ts'
export * from './routes/termdb.junction.ts'
export * from './routes/termdb.matrix.ts'
...
export * from './routes/termdb.regression.ts'
