...
export type GRIN2Request = {
	...
	/** Log cutoff for Manhattan plot rendering before we scale the y-axis (default: 40). This is not user defined but rather a constant defined in manhattanTypes.ts */
	logCutoff?: number
