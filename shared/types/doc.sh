...
rm -rf $DOCSDIR/*
cp $CHECKERSRAW/index.js $CHECKERSRAW/index.ts
npx typedoc --json $DOCSDIR/server.json
rm $CHECKERSRAW/index.ts
...
node esbuild.config.mjs ../../public/docs/server/dist
# cp -rf dist ../../public/docs/server/
