...
export function legend_mclass(block) {
	...
	for(const e of slst) {
		const butt=block.legend.td_mclass.append('div')
			...
			.on('click',()=>{
				...
				div2.append('div').text(common.mclass[e.key].label.toUpperCase())
					.style('color',common.mclass[e.key].color)
					.style('font-size','.8em')
				div2.append('div').html(common.mclass[e.key].desc)
					.style('color','#858585')
					.style('font-size','.8em')
					.style('width','210px')
				// end of click
...
export function legend_morigin(block) {
	...
	for(const e of slst) {
		const butt=block.legend.td_morigin.append('div')
			.style('display','inline-block')
			.style('white-space','nowrap')
			.style('padding', block.legend.vpad+' 20px '+block.legend.vpad+' 0px')
			.classed('sja_clb',true)
			.on('click',()=>{
				...
				const div2=tip.d.append('div').style('margin','20px')
				div2.append('div').text(common.morigin[e.key].label.toUpperCase())
					.style('color',common.morigin[e.key].color)
					.style('font-size','.8em')
				div2.append('div').html(common.morigin[e.key].desc)
					.style('color','#858585')
					.style('font-size','.8em')
					.style('width','210px')
				// end of click
