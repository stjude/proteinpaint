...
exports.findexonskipping=function(multisample, junctions, gmdata)
{
		...
		*/
		...
		if(multisample) {
			...
			*/
			...
			thisevent.percentage = Math.ceil( 100 * thisevent.junctionB.data[0].v / (thisevent.junctionB.data[0].v + asum/thisevent.junctionAlst.length) )
		}
