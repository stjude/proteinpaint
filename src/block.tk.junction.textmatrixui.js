...
export default function(genomes, hostURL, jwt) {
	...
	p.append('button').text('Submit').on('click',()=>{
		saydiv.text('')
	...
	filediv.append('p').html('<a href=https://www.dropbox.com/s/xu52ke9cify24hw/junction.txt?dl=0 target=_blank>Example file</a>')
}
