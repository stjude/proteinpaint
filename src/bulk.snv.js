...
exports.parseheader=function(line,flag) {
	...
	header[i]='pos'
	i=htry('annovar_isoform','mrna_accession', 'mrna accession','refseq_mrna_id','annovar_sj_filter_isoform','refseq','isoform')
...
exports.parseline=function(linei,line,flag) {
