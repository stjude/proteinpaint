...
# mv ./public/docs/index.html-e ./public/docs/index.html
find ./public/docs \( -type d -name .git -prune \) -o -type f -print0 | xargs -0 sed -i -e "s|<body>|<body>$d3$nav$subheader|g"
rm -rf ./public/docs/**/*.*-e
rm -rf ./public/docs/*.*-e
rm -rf ./public/docs/**/.*-e
rm -rf ./public/docs/.*-e

./src/extractTypesFromHtml.js > public/docs/extracts.json
