...
function add_rn6() {
    ...
    trydownload(path.join(path_tpanno, 'refGene.rn6.gz'), 'https://pecan.stjude.cloud/static/rn6/refGene.rn6.gz')
    trydownload(path.join(path_tpanno, 'refGene.rn6.gz.tbi'), 'https://pecan.stjude.cloud/static/rn6/refGene.rn6.gz.tbi')
    trydownload(path.join(path_tpanno, 'ensGene.rn6.gz'), 'https://pecan.stjude.cloud/static/rn6/ensGene.rn6.gz')
    trydownload(path.join(path_tpanno, 'ensGene.rn6.gz.tbi'), 'https://pecan.stjude.cloud/static/rn6/ensGene.rn6.gz.tbi')
