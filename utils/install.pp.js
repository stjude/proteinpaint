...
function add_hg38 () {
	...
	trydownload( path.join(path_tpanno,'gencode.v28.hg38.gz'), 'https://pecan.stjude.cloud/static/hg38/gencode.v28.hg38.gz')
	trydownload( path.join(path_tpanno,'gencode.v28.hg38.gz.tbi'), 'https://pecan.stjude.cloud/static/hg38/gencode.v28.hg38.gz.tbi')
...
function add_hg19 () {
	...
	trydownload( path.join(path_tpanno,'gencode.v28.hg19.gz'), 'https://pecan.stjude.cloud/static/hg19/gencode.v28.hg19.gz')
	trydownload( path.join(path_tpanno,'gencode.v28.hg19.gz.tbi'), 'https://pecan.stjude.cloud/static/hg19/gencode.v28.hg19.gz.tbi')
