...
generate_data <- function(iter) {
    group1_values <- rnorm(500)  # Generate 20 random numbers from a normal distribution
    group2_values <- runif(500)  # Generate 10 random numbers from a uniform distribution
