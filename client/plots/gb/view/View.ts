...
export class View {
	...
	async generateTracks() {
		...
		/* Tracks the launcher brought with it, e.g. a DMR scan's bedj file or a genome track switched
		on by name. Cloned so the block's per-track state never lands in app state. */
