...
import { ScatterInteractivity } from './interactions/scatterInteractivity.js'
...
import { downloadImage } from './interactions/scatterInteractivity.js'
...
class Scatter extends RxComponentInner {
	...
	async init(appState) {
		...
		if (this.model.is3D) this.viewModel = new ScatterViewModel3D(this)
		else if (this.config.isLarge) this.viewModel = new ScatterViewModel2DLarge(this)
		else this.viewModel = new ScatterViewModel(this)
	}
	...
	async main() {
		...
		if (!this.model.is3D) this.viewModel.setTools()
	}
