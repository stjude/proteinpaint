...
function getLegendGrps(termNum, self) {
	...
	// Hide descriptive statistics for termCollection, similar to boxplot behavior
	if (self.settings.showStats && t1.term.type != 'termCollection') addDescriptiveStats(t1, legendGrps, headingStyle, self)
