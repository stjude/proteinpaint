...
import { SelectionRender } from './view/SelectionRender'
...
class SCViewer extends PlotBase implements RxComponentInner {
	readonly type = 'sc'
	components: {
	...
	async init(appState: MassState) {
		...
		this.view = new SelectionRender(this.interactions, this.dom, this.viewModel.tableData)
	}
