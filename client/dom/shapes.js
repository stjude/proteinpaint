...
export const shapes = {
	...
	//**** Will likely not use *****/
	// plusIcon: 'M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2', //plus
...
export const shapesArray = Object.values(shapes)
