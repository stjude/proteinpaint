...
export const useCasesExcluded = {
	matrix: [SNP_LOCUS, SNP_LIST, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	facet: [SNP_LOCUS, SNP_LIST, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	filter: [SNP_LOCUS, SNP_LIST],
	dictionary: [SNP_LOCUS, SNP_LIST, COHORT],
	summary: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, COHORT],
	summaryInput: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	...
	survival: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	//Used from the termsetting when searching for a term, as any term with categories is allowed
	default: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	regression: [SNP_LIST, SNP_LOCUS, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, COHORT],
	metaboliteIntensity: [
		SNP_LOCUS,
		SNP_LIST,
		MUTATION_CNV_FUSION,
	...
	correlationVolcano: [SNP_LOCUS, SNP_LIST, MUTATION_CNV_FUSION, TERM_COLLECTION, COHORT],
