...
export const useCasesExcluded = {
	matrix: [SNP_LOCUS, SNP_LIST, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	facet: [SNP_LOCUS, SNP_LIST, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	filter: [SNP_LOCUS, SNP_LIST, PSEUDOBULK],
	dictionary: [SNP_LOCUS, SNP_LIST, PSEUDOBULK],
	summary: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, PSEUDOBULK],
	summaryInput: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	barchart: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, PSEUDOBULK],
	violin: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, PSEUDOBULK],
	sampleScatter: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, PSEUDOBULK],
	cuminc: [
		SNP_LOCUS,
		SNP_LIST,
		MUTATION_CNV_FUSION,
	...
	survival: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	//Used from the termsetting when searching for a term, as any term with categories is allowed
	default: [SNP_LOCUS, SNP_LIST, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	regression: [SNP_LIST, SNP_LOCUS, TERM_COLLECTION, SINGLECELL_CELLTYPE, SINGLECELL_GENE_EXPRESSION, PSEUDOBULK],
	metaboliteIntensity: [
		SNP_LOCUS,
		SNP_LIST,
		MUTATION_CNV_FUSION,
	...
	correlationVolcano: [SNP_LOCUS, SNP_LIST, MUTATION_CNV_FUSION, TERM_COLLECTION, PSEUDOBULK],
