...
tape('GDC - barchart - categorical', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - barchart - geneVariant', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - barchart - geneExpression', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - barchart - categorical/categorical', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - barchart - categorical/geneVariant', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - barchart - categorical/geneExpression', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - violin - geneExpression', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - violin - geneExpression/categorical', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - violin - geneExpression/geneVariant', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - boxplot - geneExpression', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - boxplot - geneExpression/categorical', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
...
tape('GDC - boxplot - geneExpression/geneVariant', test => {
	const holder = getHolder()
	runproteinpaint({
		holder,
		mass: {
