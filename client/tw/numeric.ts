import { NumericTerm, NumericQ, CatTWValues, CatTWPredefinedGS, CatTWCustomGS, RawNumericTW } from '#types'
import { TwBase, TwOpts } from './TwBase'

export class NumericDiscrete extends TwBase {
	term: NumericTerm
	q: NumericQ
	#tw: NumericTWDiscrete
	#opts: TwOpts

	// declare a constructor, to narrow the tw type
	constructor(tw: NumericTWDiscrete, opts: TwOpts = {}) {
		super(tw, opts)
		this.term = tw.term
		this.q = tw.q
		this.#tw = tw
