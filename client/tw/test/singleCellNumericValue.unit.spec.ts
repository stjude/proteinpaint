...
tape('constructor: throws error for null term', function (test) {
	test.throws(() => new SingleCellNumericValueBase(null as any), /term is not an object/, 'throws error for null term')
	test.end()
})
...
tape('constructor: throws error for non-object term', function (test) {
	...
	test.throws(() => new SingleCellNumericValueBase(123 as any), /term is not an object/, 'throws error for number term')
	test.end()
})
...
tape('constructor: throws error for null term.sample', function (test) {
	...
	test.throws(() => new SingleCellNumericValueBase(term as any), /missing term.sample/, 'throws error for null sample')
	test.end()
})
...
tape('validate: accepts valid term', function (test) {
	const term = createValidTerm()
	test.doesNotThrow(() => SingleCellNumericValueBase.validate(term as any), 'validate accepts valid term')
	test.end()
})

tape('validate: accepts valid term without plot', function (test) {
	const term = createValidTerm({ plot: undefined })
	test.doesNotThrow(() => SingleCellNumericValueBase.validate(term as any), 'validate accepts term without plot')
	test.end()
})
...
tape('fill: does not throw for valid raw term', function (test) {
	const term = createValidTerm()
	test.doesNotThrow(() => SingleCellNumericValueBase.fill(term as any), 'fill does not throw for valid raw term')
	test.end()
})
...
tape('fill: handles term with optional name property', function (test) {
	...
	test.doesNotThrow(() => SingleCellNumericValueBase.fill(term as any), 'fill accepts term with optional name property')
	test.end()
})
