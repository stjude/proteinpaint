...
tape('Test #1: Out-of-bounds genomic ranges (query_end < genomic_start)', async t => {
	const input = {
		h: 'server/test/tp/files/hg38/TermdbTest/dnaMeth.h5',
		s: '1',
		g: 'chr17:50-50'
	}
