...
module.exports={
	...
	dsinfo:[
		{k:'Preparation',v:'Variants from a VCF file is annotated with VEP, then converted to a tabular format similar to MAF, then load into a sqlite db to be shown here'},
	],
	genome:'hg19',
	color:'#931638',
