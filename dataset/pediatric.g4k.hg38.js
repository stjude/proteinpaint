		...
		*/
		cohort: {
			files: [
				...
				{ file: 'hg38/Pediatric/sjcloud.sub/G4K/sampletable/g4k.samples' }
			],
		...
		queries: {
			svcnv: {
				name: 'Pediatric_G4K tumor mutation',
				istrack: true,
				type: common.tkt.mdssvcnv,
				file: 'hg38/Pediatric/sjcloud.sub/G4K/pediatric_g4k.svcnv.hg38.gz',
			...
			snvindel: {
				...
				tracks: [
					{
						file: 'hg38/Pediatric/sjcloud.sub/G4K/pediatric_g4k.hg38.vcf.gz',
						type: 'vcf'
					}
				],
				singlesamples: {
					tablefile: 'hg38/Pediatric/sjcloud.sub/G4K/split.vcf/table'
				}
			},
			...
			genefpkm: {
				...
				isgenenumeric: true,
				file: 'hg38/Pediatric/sjcloud.sub/G4K/pediatric_g4k.fpkm.hg38.gz',
				datatype: 'FPKM',
