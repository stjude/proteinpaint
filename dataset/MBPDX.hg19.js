...
module.exports={
	...
	sampleAssayTrack:{
		file:'files/hg19/MBPDX/tracktable/__table'
	},
	/*
	...
	*/
     ...
     */
     ...
     cohort:{
     	files:[
     		{file:'files/hg19/MBPDX/sampletable/sample.table'},
     	],
     ...
     queries:{
     	svcnv:{
     		...
     		file:'files/hg19/MBPDX/svcnv.sorted.gz',
     	...
     	snvindel:{
     		...
     		tracks:[
     			{
     				file:'files/hg19/MBPDX/MBPDX.snvindel.vcf.gz',
     				type:'vcf',
     			}
     		],
     		singlesamples:{
     			tablefile:'files/hg19/MBPDX/split.vcf/table'
     		}
     	},
     	...
     	genefpkm:{
     		...
     		isgenenumeric:true,
     		file:'files/hg19/MBPDX/MBPDX.fpkm.gz',
     		datatype:'FPKM',
