...
const cohorthierarchy = [{ k: 'Tumor_Site_Broad', label: 'Site' }, { k: 'Diagnosis_Broad', label: 'Cancer' }]
...
module.exports = {
	...
	*/
	...
	cohort: {
		files: [{ file: 'hg19/clingen/subset/G4K/sampletable/G4K.sample' }],
	...
	queries: {
		svcnv: {
			...
			groupsamplebyattr: {
				attrlst: [{ k: 'Tumor_Site_Broad', label: 'Site' }, { k: 'Diagnosis_Broad', label: 'Cancer' }],
				sortgroupby: {
		...
		genefpkm: {
			...
			boxplotbysamplegroup: {
				attributes: [{ k: 'Tumor_Site_Broad', label: 'Site' }, { k: 'Diagnosis_Broad', label: 'Cancer' }]
			}
		}
	}
}
