...
module.exports={
	...
	*/
	cohort:{
		files:[
			{file:'hg19/pan-allHistoneDel/sampletable/PanALL_SampleTable_GenomePaint_2020-5-13.txt'},
		],
...
*/
	...
	queries:{
		svcnv:{
			...
			file:'hg19/pan-allHistoneDel/PanALL_CnvSvTable_GenomePaint_2020-5-13.svcnv.gz',
