...
module.exports = function(common) {
	return {
		...
		*/
		cohort: {
			files: [{ file: 'hg19/pan-nbl-cp/sampletable/PanNBL_SampleTable_GenomePaint.txt' }],
	...
	*/
		...
		queries: {
			svcnv: {
				...
				file: 'hg19/pan-nbl-cp/PanNBL_CnvSvTable_GenomePaint.svcnv.gz',
	...
	*/
			...
			genefpkm: {
				hideforthemoment: 1,
				name: 'Pan-NBL RNA-seq gene FPKM',
				isgenenumeric: true,
				file: 'hg19/pan-nbl-cp/PanNBL_FpkmTable_GenomePaint.fpkm.gz',
				datatype: 'FPKM',
