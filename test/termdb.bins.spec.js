...
tape("get_bin_label()", function (test) {
  ...
  test.equal(
    b.get_bin_label({startunbounded:1, stop: 3, stopinclusive: 1}, get_summary),
    "≤3",
    "startunbounded + stopinclusive"
  )
  
  test.deepEqual(
    b.get_bin_label({stopunbounded:1, start: 30}, {bin_size: 3}, get_summary),
    ">30",
    "stopunbounded"
  )
...
tape.only("get_bins() percentile", function (test) {
  ...
  test.deepLooseEqual(
    ...
    [ 
      { startunbounded: undefined, start: 2, stop: 4, startinclusive: 1, stopinclusive: 0, label: '2 to <4' },
      { startinclusive: 1, stopinclusive: 0, start: 4, stop: 7, label: '4 to <7' },
      { startinclusive: 1, stopinclusive: 0, start: 7, stop: 10, label: '7 to <10' },
      { startinclusive: 1, stopinclusive: 0, start: 10, stop: 13, label: '10 to <13' },
      { startinclusive: 1, stopinclusive: 0, start: 13, stop: 16, label: '13 to <16' },
      { startinclusive: 1, stopinclusive: 0, start: 16, stop: 19, label: '16 to <19' },
  ...
  test.deepLooseEqual(
    b.get_bins({bin_size: 4, first_bin: {start:4}, last_bin: {start_percentile:90}}, get_summary),
    [
      { startunbounded: undefined, start: 4, stop: 8, startinclusive: 1, stopinclusive: 0, label: '4 to <8' },
      { startinclusive: 1, stopinclusive: 0, start: 8, stop: 12, label: '8 to <12' },
