...
tape("term1", function (test) {
  ...
  request(url0,(error,response,body)=>{
    ...
    case 200:
      ...
      test.deepEqual(
        JSON.parse(body), 
        {"charts":[{"chartId":"","total":9138,"serieses":[{"total":4981,"seriesId":"Male","data":[{"dataId":"","total":4981}]},{"total":4157,"seriesId":"Female","data":[{"dataId":"","total":4157}]}],"maxSeriesTotal":4981}],"refs":{"cols":["Male","Female"],"colgrps":["-"],"rows":[""],"rowgrps":["-"],"col2name":{"Male":{"name":"Male","grp":"-"},"Female":{"name":"Female","grp":"-"}},"row2name":{"":{"name":"","grp":"-"}}},"maxAcrossCharts":4981},
