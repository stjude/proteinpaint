	...
	return (function(e) {
		...
		function(e, t, n) {
			...
			var r = n(16),
				...
				o = n(19)
			console.log('test ....'),
				console.log(a.defaultcolor),
				console.log(10, r.runproteinpaint),
				(0, r.runproteinpaint)({
					holder: (0, o.select)('body')
						.append('div')
						.node(),
					noheader: 1,
					nobox: !0,
					termdb: {
									...
									lst: [
										{
											...
											tvs: {
												term: {
													...
													type: 'float',
													values: {
														0: { label: 'Not exposed', uncomputable: !0 },
														'-8888': { label: 'Exposed but dose unknown', uncomputable: !0 },
														'-9999': { label: 'Unknown treatment record', uncomputable: !0 }
													}
												},
												ranges: [
													{ value: '0', label: 'Not exposed' },
													{ startunbounded: !0, stop: 2e3, stopinclusive: !0 }
												]
											}
										}
									]
						...
						barchart: { bar_click_opts: ['hide_bar', 'add_filter', 'select_to_gp'] }
					}
				})
		},
					...
					(t = function() {
						return (function(e) {
							...
							function(e, t, n) {
								...
								Object.defineProperty(t, 'Partjson', {
									...
									(t.fasta2gmframecheck = function(e, t) {
										...
										var r = U(e),
											a = l
										return r.indexOf(q) == r.length - 1 && (a = i), a
									}),
							...
							function(e, t, n) {
								...
								var o,
									i = p(n(6)),
									l = (o = n(122)) && o.__esModule ? o : { default: o },
									u = n(57),
									s = n(64),
									f = n(20),
									c = n(29),
								...
								!(function(o, i) {
									...
									;(e.prototype['@split'] = function(e) {
										...
										(e.prototype['@before'] = function(e, t) {
											var n = e.slice(1, -2)
											return (
												this.Pj.opts['='][n] || (t.errors.push(['val', 'MISSING-' + t.term + '-FXN', n]), this.trueFxn)
											)
										}),
									...
									;(n.prototype[','] = function(e, t) {
										...
										(n.prototype['[{}]'] = function(e, t) {
											...
											if ('string' == typeof r) {
												var a = this.Pj.converter.default(
														this.Pj,
														Object.assign({}, { templateVal: r }),
														t.inheritedIgnore,
														r
													),
													i = o(a, 2),
										...
										(n.prototype['+,'] = function(e, t) {
											...
											return function(r, a, o, i) {
												...
												var l = e(r, i)
												t.ignore(l, a, r, i) ||
													(n.isNumeric(l) ? (o[a] += +l) : i.errors.push([t, 'NON-NUMERIC-INCREMENT', r]))
											}
										}),
										(n.prototype['+,()'] = n.prototype['+,']),
										(n.prototype['+,[]'] = function(e, t) {
										...
										(n.prototype['-,'] = function(e, t) {
											...
											return function(r, a, o, i) {
												...
												var l = e(r, i)
												t.ignore(l, a, r, i) ||
													(n.isNumeric(l) ? (o[a] += -l) : i.errors.push([t, 'NON-NUMERIC-DECREMENT', r]))
											}
										}),
										(n.prototype['-,()'] = n.prototype['-,']),
										(n.prototype['-,[]'] = function(e, t) {
													...
													value: function(e, t) {
														if (t) {
																				...
																				: 'val' == h &&
																				  (Array.isArray(a.templateVal)
																						? (this.track(n, d, a.templateVal[0]),
																						  this.mode.input &&
																								(e[a.term] = ['{{ ' + v + ' }} '].concat(u(a.templateVal))))
																...
																try {
																	for (var _, x = t.errors[Symbol.iterator](); !(y = (_ = x.next()).done); y = !0) {
																		var w = _.value,
																			...
																			k = j[0],
																			O = j[1]
																		if ((j[2], this.track(n, w, k.term), this.mode.input)) {
																			var M = '{{ ' + O + ' }} ' + k.term
																			M in m || (m[M] = 0), (m[M] += 1)
																		}
																	}
															...
															if (t.filler.errors.length) {
																...
																try {
																	for (
																		var C, N = t.filler.errors[Symbol.iterator]();
																		!(P = (C = N.next()).done);
																		P = !0
																	) {
																		var T = C.value
									...
									function a(e, t) {
										var n = e.skipSymbols.includes(t[0]) ? t[0] : '',
											...
											f =
												u && s ? t.slice(o + 1, -2) : u ? t.slice(o + 1) : s ? t.slice(o, -2) : n || a ? t.slice(o) : t,
										...
										return [
											f,
											d,
											{ skip: n, time: a, aggr: u, subs: c, stem: p, conv: s, subterm: f },
											e.steps.indexOf(a)
										]
									}
									var f = {
									...
									var d = Object.freeze({
											...
											default: function(e, t, n, r) {
												...
												var d = u + s.conv
												if (((t.ignore = d in n ? n[d] : n['@']), s.skip && '~' != s.skip))
													return f[s.skip](e, u, t), []
												if (s.subs in f) {
															...
															try {
																for (var i, l = e[Symbol.iterator](); !(n = (i = l.next()).done); n = !0) {
																	...
																	if (this.split) {
																		...
																		try {
																			for (
																				var d, p = this.split(u)[Symbol.iterator]();
																				!(s = (d = p.next()).done);
																				s = !0
																			) {
																				var h = d.value
																				...
																				if (y.keyFxn && y.valFxn) {
																					...
																					try {
																						for (var w, j = g[Symbol.iterator](); !(b = (w = j.next()).done); b = !0) {
																							...
																							y.valFxn(e, k, n, r),
																								'~' == y.keyTokens.skip &&
																									(this.temps.has(n) || this.temps.set(n, new Set()),
																									this.temps.get(n).add(k))
																						}
																					} catch (e) {
																						;(_ = !0), (x = e)
																					} finally {
													...
													},
													{
														...
														value: function(e, t) {
															...
															if (t && t.filler && t.filler.postTerms[n]) {
																...
																try {
																	for (
																		var i, l = t.filler.postTerms[n][Symbol.iterator]();
																		!(r = (i = l.next()).done);
																		r = !0
																	) {
																		var u = i.value,
																	...
																	e.termdb &&
																		(function(e, t) {
																			e.holder || (e.holder = t),
																				...
																				Promise.all([n.e(0), n.e(1), n.e(4), n.e(15), n.e(39)])
							...
							function(e, t, n) {
								...
								var r,
									a = n(4),
									o = n(71),
									i = (r = n(133)) && r.__esModule ? r : { default: r }
								...
								Object.defineProperty(t, '__esModule', { value: !0 }),
									...
									(t.parse = async function(e) {
										...
										if (t.has('mdsjsonform')) {
											var s = await Promise.all([n.e(0), n.e(1), n.e(4), n.e(29), n.e(47)]).then(n.t.bind(null, 320, 7))
		...
		function(e, t, n) {
			...
			m[b] = { label: 'N-terminus loss', color: '#545454', dt: p, desc: 'N-terminus loss due to translocation' }
			var _ = (t.mclasscloss = 'CLOSS')
			m[_] = { label: 'C-terminus loss', color: '#545454', dt: h, desc: 'C-terminus loss due to translocation' }
