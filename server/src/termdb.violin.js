...
/*
param: getViolinRequest
returns: getViolinResponse
*/

export async function trigger_getViolinPlotData(q, res, ds, genome) {
	if (q.singlecellGeneExpression) {
		// sc gene exp data cannot be expressed as a term; thus the support via this exception
		return await getSinglecellGeneExpViolin(q, res, ds)
	}
...
async function getSinglecellGeneExpViolin(q, res, ds) {}
