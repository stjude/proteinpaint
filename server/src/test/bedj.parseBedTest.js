...
tape('test #1: parsing a line from hg38 gencodeV41.bb file', function(test) {
	const bedLine = [
		'chr17',
		'7661778',
		'7676594',
...
tape('test #2: parsing a line from dbsnp.hg19.bb file', function(test) {
	const bedLine = [
		'chr17',
		'7579867',
		'7579868',
...
tape('test #3: parsing a line from lrg.bb file', async function(test) {
	const bedLine = [
		'chr17',
		'7681070',
		'7705502',
...
tape('test #4: parsing the line for gene IGKC from hg38 gencodeV41.bb file', function(test) {
	const bedLine = [
		'chr2',
		'88857160',
		'88857683',
...
tape('test #5: parsing a line from genCC.bb', function(test) {
	const bedLine = [
		'chr17',
		'7668420',
		'7687490',
...
tape('test #6: parsing a line from dbSnp153BadCoords.bb, four columns', function(test) {
...
tape('test #7: parsing a line from hgmd.bb, strand == .', function(test) {
	const bedLine = [
		'chr17',
		'7687375',
		'7687376',
...
tape('test #8: parsing a line from interactions.bb', function(test) {
	const bedLine = [
		'chr17',
		'7687439',
		'7703502',
...
tape('test#9: parsing a line from miRnaAtlasSample1.bb', function(test) {
	const bedLine = [
		'chr17',
		'8088066',
		'8088083',
