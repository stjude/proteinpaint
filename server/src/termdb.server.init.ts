...
/*
	...
	- numericDictTermCluster is not defined here; it is defined in the specific dataset that requires it.
...
const defaultCommonCharts: isSupportedChartCallbacks = {
	...
	*/
	...
	aggregateMatrix: ({ ds }) => ds.queries?.singleCell?.pseudobulk,
	aggMatrixInput: ({ ds }) => ds.queries?.singleCell?.pseudobulk
}
