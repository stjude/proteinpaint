...
function hardcodeBinconfigs() {
	...
	const id2binStat = {
		...
		'case.diagnoses.pathology_details.peripancreatic_lymph_nodes_tested': { bin_size: 10, first_bin_stop: 65 },
		...
		'case.diagnoses.treatments.days_to_treatment_end': { bin_size: 1000, first_bin_stop: 5000 },
