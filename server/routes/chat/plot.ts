 ...
 * @returns            The specific plot type (e.g. 'summary', 'dge', 'survival', 'matrix', 'prebuiltScatter', 'hiercluster', 'lollipop').
 */
...
*/
	...
	const prompt = `You are a classifier. Given a user query about data visualization, respond with exactly one word from this list: summary, dge, survival, matrix, prebuiltScatter, hiercluster, lollipop.
...
IMPORTANT: Your response must be exactly one word. Do not return chart type names like "violin", "box plot", or "bar chart". Return only: summary, dge, survival, matrix, prebuiltScatter, hiercluster, or lollipop.    
