...
function validate_summary_response(response: string, common_genes: string[], ds: any) {
	...
	const term1_validation = validate_term(response_type.term, common_genes, ds)
	...
	if (response_type.term2) {
		const term2_validation = validate_term(response_type.term2, common_genes, ds)
