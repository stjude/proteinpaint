...
// Constants & types
const MAX_LESIONS_PER_TYPE = serverconfig.features.grin2maxLesionPerType || 1600000 // Maximum number of lesions to process per type to avoid overwhelming the production server
