	...
	cohort: {
		...
		termdb: {
			...
			selectCohort: {
				...
				description:
					'The St. Jude Survivorship Portal is a data portal for exploring, analyzing, visualizing, and sharing data from survivors of pediatric cancer. The portal hosts a wide range of data types collected from cancer survivors, including demographic, genetic, cancer treatment, and clinical outcome data. These datasets were generated by two large-scale longitudinal studies of pediatric cancer survivors: the St. Jude Lifetime Cohort study (SJLIFE) and the Childhood Cancer Survivor Study (CCSS). Users can choose one or both of these cohorts to analyze in the portal. Once a cohort is selected, the user may then click on the "CHARTS" tab to explore, analyze, visualize, and download the data of this cohort.',
				prompt:
